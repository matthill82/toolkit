angular
    .module('uitoolkit')
    .controller('PlansRecommendationsController', PlansRecommendationsController);

// TODO This is a beast, move the business logic into a service and whatever else can be done to make it more comprehensible.
function PlansRecommendationsController($filter, $sce, $state, $window, DeviceService, PlanService, StateManagement) {
